...
class ArtisanProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final itineraryState = context.watch<ItineraryState>();
  ...
  Widget _buildSliverAppBar(BuildContext context, bool isSaved, ItineraryState state) {
    return SliverAppBar(
      expandedHeight: 450,
      pinned: true,
      stretch: true,
  ...
  Widget _buildActionCard(BuildContext context, bool isSaved, ItineraryState state) {
    return Container(
