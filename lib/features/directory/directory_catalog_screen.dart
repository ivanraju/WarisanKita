...
import 'package:warisan_kita/features/directory/artisan_profile_screen.dart';
...
class DirectoryCatalogScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final directoryState = context.watch<DirectoryState>();
  ...
  Widget _buildSliverAppBar(BuildContext context, DirectoryState state) {
    return SliverAppBar(
      expandedHeight: 180,
      floating: true,
      pinned: true,
  ...
  Widget _buildSearchBar(DirectoryState state) {
    return Container(
  ...
  Widget _buildFilterSection(DirectoryState state) {
