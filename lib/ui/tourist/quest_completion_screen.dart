...
class _QuestCompletionScreenState extends State<QuestCompletionScreen> {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                        langVM.translate('Scan Artisan Quest QR Code'),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            langVM.translate('Align Artisan QR Code inside frame'),
                            style: GoogleFonts.plusJakartaSans(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            langVM.translate('LIVE SCANNER READY'),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              langVM.translate(
                                'Handshake failed. That QR code does not belong to this artisan.',
                              ),
                            ),
                            backgroundColor: const Color(0xFFEF4444),
                          ),
                      ...
                      child: Text(langVM.translate('Test Invalid QR')),
                    ),
                  ),
                  ...
                  Expanded(
                    child: FilledButton(
                      ...
                      child: Text(langVM.translate('SCAN VALID QR')),
                    ),
                  ),
                ],
              ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    ...
                    child: Text(langVM.translate('DONE')),
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          langVM.translate('Cultural Quest Hub'),
          style: GoogleFonts.dmSerifDisplay(
            color: const Color(0xFF004D40),
            fontSize: 22,
          ),
          ...
          children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              _isWithinRange
                                  ? '35m (${langVM.translate('IN RANGE')})'
                                  : langVM.translate('OUT OF RANGE'),
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            langVM.translate('Est. 45 Mins Session'),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  Text(
                    langVM.translate('Distance Testing:'),
                    style: GoogleFonts.plusJakartaSans(
                      fontSize: 11,
                  ...
                  const SizedBox(width: 10),
                  ChoiceChip(
                    label: Text('${langVM.translate('In Range')} (35m)'),
                  ...
                  const SizedBox(width: 8),
                  ChoiceChip(
                    label: Text('${langVM.translate('Out Range')} (85m)'),
                    selected: !_isWithinRange && !_isGpsLost,
                    onSelected: (_) => setState(() {
            ...
            Text(
              langVM.translate('Quest Checklist & Steps'),
              style: GoogleFonts.dmSerifDisplay(
                fontSize: 20,
                color: const Color(0xFF004D40),
              ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            langVM.translate(item['subtitle']),
                            style: GoogleFonts.plusJakartaSans(
                              fontSize: 11,
                              color: Colors.grey[600],
                            ),
            ...
            if (!_isQuestStarted)
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(
                    langVM.translate('START QUEST & TIMER'),
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                    ),
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(
                    langVM.translate('SCAN ARTISAN\'S QUEST QR CODE'),
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                    ),
