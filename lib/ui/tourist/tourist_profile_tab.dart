...
class _TouristProfileTabState extends State<TouristProfileTab> {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: isDark ? const Color(0xFF041412) : const Color(0xFFFFF8E1),
              image: DecorationImage(
                ...
                // The source artwork is intentionally pale, so it needs a
                // stronger composite opacity for its edge motifs to remain
                // visible behind the cream page treatment.
        ...
        RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              ...
                              colors: [Color(0xFF062B27), Color(0xFF004D40)],
                            ),
              ...
              else if (gameStat.passportError != null &&
                  gameStat.stamps.isEmpty)
                SliverToBoxAdapter(
                  child: Padding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      return Semantics(
                        button: true,
                        label: unlocked
                            ? '${stamp.title}, earned heritage stamp'
                            : '${stamp.title}, locked. Complete quest to unlock',
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                _buildStampArtwork(stamp, color, size: 72),
                                ...
                                if (stamp.questTitle.isNotEmpty) ...[
                                  Text(
                                    ...
                                    style: GoogleFonts.plusJakartaSans(
                                      ...
                                      color: unlocked
                                          ? (isDark
                                                ? const Color(0xFFB8D8CF)
                                                : const Color(0xFF45635C))
                                          : (isDark
                                                ? const Color(0xFF9BB0A8)
  ...
  Widget _buildStampCollectionProgress(
    ...
    final earned = state.earnedPassportStamps.length;
    final hasTotal =
        state.hasAvailablePassportStampData &&
        state.availablePassportStamps > 0;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark
            ? const Color(0xFF0D2825).withValues(alpha: 0.94)
            : const Color(0xFFFFFCF4).withValues(alpha: 0.94),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(
          color: isDark ? const Color(0xFF31564E) : const Color(0xFFE5D8B6),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            countLabel,
            style: GoogleFonts.plusJakartaSans(
              color: isDark ? const Color(0xFFF5EBCF) : const Color(0xFF004D40),
              fontSize: 11,
              fontWeight: FontWeight.w800,
            ),
          ),
